...
public class TestGalicianHunspellAnalyzer extends HunspellAnalyzerTestCase {
  ...
  public void testStopWord() throws Exception {
    Analyzer a = new GalicianHunspellAnalyzer(getDictionary());
  ...
  public void testStemExclusion() throws IOException{
    ...
    set.add("primeira");
    Analyzer a = new GalicianHunspellAnalyzer(getDictionary(), CharArraySet.EMPTY_SET, set);
    assertAnalyzesTo(a, "primeira", new String[] {"primeira"});
  }
  
  /** blast some random strings through the analyzer */
  public void testRandomStrings() throws Exception {
    checkRandomData(random(), new GalicianHunspellAnalyzer(getDictionary()), 1000*RANDOM_MULTIPLIER);
  }
}
