...
public class TestLatvianHunspellAnalyzer extends HunspellAnalyzerTestCase {
  ...
  public void testStopWord() throws Exception {
    Analyzer a = new LatvianHunspellAnalyzer(getDictionary());
  ...
  public void testStemExclusion() throws IOException{
    ...
    set.add("kurmjiem");
    Analyzer a = new LatvianHunspellAnalyzer(getDictionary(), CharArraySet.EMPTY_SET, set);
    assertAnalyzesTo(a, "kurmjiem", new String[] {"kurmjiem"});
  }
  
  /** blast some random strings through the analyzer */
  public void testRandomStrings() throws Exception {
    checkRandomData(random(), new LatvianHunspellAnalyzer(getDictionary()), 1000*RANDOM_MULTIPLIER);
  }
}
