package org.elasticsearch.analysis.hunspell.pt_PT;
...
/** 
 * Hunspell-based analyzer for Portuguese
 */
public final class PortugueseHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public PortugueseHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public PortugueseHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
