package org.elasticsearch.analysis.hunspell.eu;
...
/** 
 * Hunspell-based analyzer for Basque
 */
public final class BasqueHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public BasqueHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public BasqueHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
