...
/** 
 * Hunspell-based analyzer for Latvian
 */
public final class LatvianHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public LatvianHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public LatvianHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getWordSet(
                        IOUtils.getDecodingReader(LatvianAnalyzer.class, LatvianAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
                        "#", 
