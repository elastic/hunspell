...
/** 
 * Hunspell-based analyzer for Tajik
 */
public final class TajikHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public TajikHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public TajikHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getWordSet(
                        IOUtils.getDecodingReader(TajikHunspellAnalyzer.class, TajikHunspellAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
                        "#", 
