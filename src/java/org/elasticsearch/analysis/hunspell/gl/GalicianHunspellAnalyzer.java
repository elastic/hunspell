...
/** 
 * Hunspell-based analyzer for Galician
 */
public final class GalicianHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public GalicianHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public GalicianHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getWordSet(
                        IOUtils.getDecodingReader(GalicianAnalyzer.class, GalicianAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
                        "#", 
