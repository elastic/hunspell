package org.elasticsearch.analysis.hunspell.sk;
...
/** 
 * Hunspell-based analyzer for Slovak
 */
public final class SlovakHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public SlovakHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public SlovakHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getWordSet(
                        IOUtils.getDecodingReader(SlovakHunspellAnalyzer.class, SlovakHunspellAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
                        "#", 
