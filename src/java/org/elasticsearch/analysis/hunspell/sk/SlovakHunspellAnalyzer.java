...
public final class SlovakHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public SlovakHunspellAnalyzer(Dictionary dictionary) {
   ...
   */
  public SlovakHunspellAnalyzer(Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    super(stopwords);
