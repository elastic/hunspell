...
public final class UkrainianHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public UkrainianHunspellAnalyzer(Dictionary dictionary) {
   ...
   */
  public UkrainianHunspellAnalyzer(Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    super(stopwords);
