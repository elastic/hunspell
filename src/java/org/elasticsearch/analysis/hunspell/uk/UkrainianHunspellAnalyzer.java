...
/** 
 * Hunspell-based analyzer for Ukrainian
 */
public final class UkrainianHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public UkrainianHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public UkrainianHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getWordSet(
                        IOUtils.getDecodingReader(UkrainianHunspellAnalyzer.class, UkrainianHunspellAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
                        "#", 
