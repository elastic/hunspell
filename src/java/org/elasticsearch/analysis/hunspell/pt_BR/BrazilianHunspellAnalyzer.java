...
public final class BrazilianHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public BrazilianHunspellAnalyzer(Dictionary dictionary) {
   ...
   */
  public BrazilianHunspellAnalyzer(Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    super(stopwords);
