...
/** 
 * Hunspell-based analyzer for Russian
 */
public final class RussianHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public RussianHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public RussianHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getSnowballWordSet(
                        IOUtils.getDecodingReader(SnowballFilter.class, RussianAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
