package org.elasticsearch.analysis.hunspell.pl;
...
/** 
 * Hunspell-based analyzer for Polish
 */
public final class PolishHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public PolishHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public PolishHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getWordSet(
                        IOUtils.getDecodingReader(PolishHunspellAnalyzer.class, PolishHunspellAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
                        "#", 
