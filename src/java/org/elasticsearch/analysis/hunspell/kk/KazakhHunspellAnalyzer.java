...
public final class KazakhHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public KazakhHunspellAnalyzer(Dictionary dictionary) {
   ...
   */
  public KazakhHunspellAnalyzer(Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    super(stopwords);
