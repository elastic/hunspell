package org.elasticsearch.analysis.hunspell.kk;
...
/** 
 * Hunspell-based analyzer for Kazakh
 */
public final class KazakhHunspellAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public KazakhHunspellAnalyzer(Version matchVersion, Dictionary dictionary) {
   ...
   */
  public KazakhHunspellAnalyzer(Version matchVersion, Dictionary dictionary, CharArraySet stopwords, CharArraySet stemExclusionTable) {
    ...
    static {
      try {
        DEFAULT_SET = WordlistLoader.getWordSet(
                        IOUtils.getDecodingReader(KazakhHunspellAnalyzer.class, KazakhHunspellAnalyzer.DEFAULT_STOPWORD_FILE, StandardCharsets.UTF_8), 
                        "#", 
